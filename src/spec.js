...
const factors = [
  ...
  { name: "c47", text: "§47 累犯" },
  { name: "c112", text: "兒少§112 成年人教唆、幫助或利用兒童及少年犯罪" /*{ "*": "兒少§112 成年人教唆、幫助或利用兒童及少年犯罪", "2011-11-30": "兒少§70 成年人教唆、幫助或利用兒童及少年犯罪" }*/ },
  { name: "c134", text: "§134 公務員利用職權機會" },
  { name: "c18_2", text: "§18(2) 十四歲以上未滿十八歲" },
  { name: "c18_3", text: "§18(3) 滿八十歲" },
  { name: "c19_2", text: "§19(2) 辨識、控制能力顯著減低" },
  { name: "c20", text: "§20 瘖啞" },
  { name: "c23", text: "§23 防衛過當" },
  { name: "c24_1", text: "§24(1) 避難過當" },
  { name: "c25_2", text: "§25(2) 普通未遂" },
  { name: "c27_1", text: "§27(1) 中止犯" },
  { name: "c30", text: "§30 幫助犯" },
  { name: "c31_1", text: "§31(1) 身分犯無特定關係之共犯" },
  { name: "c59", text: "§59 情狀顯可憫恕" },
  { name: "c62", text: "§62 自首" },
  { name: "c63", text: "§63 老幼處刑", disabled: true },
  { name: "cp14_1", text: "證保§14(1) 污點證人" },
  { name: "cp7", text: "速審§7 訴訟延滯", valid_after: '2010-05-19' },
];
